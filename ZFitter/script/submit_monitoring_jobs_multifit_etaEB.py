...
ntupleName   =   "Cal_Oct2017_PS_EoP_v1"
...
os.system("mkdir   Job_monitoring_"+ntupleName+"_etaEB")
...
for   i   in   range(len(categories)):
   for k in range(0,85):
       ietamin   =   k
       ietamax   =   k+1
       fn   =   "Job_monitoring_"+ntupleName+"_etaEB/Job_"+categories[i]+"_ietamin_"+str(ietamin*(1))+"_ietamax_"+str(ietamax*(1))+"_1nw"
       #fn   =   "Job_monitoring_"+ntupleName+"_etaEB/Job_"+categories[i]+"_ietamin_"+str(ietamax*(-1))+"_ietamax_"+str(ietamin*(-1))+"_1nw"
         
       outScript   =   open(fn+".sh","w");
       #command   =   "ZFitter.exe   -f   /afs/cern.ch/user/v/vciriolo/work/private/EOverP/CMSSW_8_0_24_patch1/src/Calibration/ZFitter/data/validation/"+ntupleName+".dat   --evtsPerPoint   "+events[i]+"   --laserMonitoringEP   --EBEE   "+categories[i]+"   --yMIN   "+yMIN[i]+"   --yMAX   "+yMAX[i]+"   --LUMI   17.8   --dayMin   15-03-2016   --dayMax   30-12-2017   --noPU   --IetaMax   "+   str(ietamin*(-1))   +   "   --IetaMin   "   +   str(ietamax*(-1))
       command   =   "ZFitter.exe   -f   /afs/cern.ch/user/v/vciriolo/work/private/EOverP/CMSSW_8_0_24_patch1/src/Calibration/ZFitter/data/validation/"+ntupleName+".dat   --evtsPerPoint   "+events[i]+"   --laserMonitoringEP   --EBEE   "+categories[i]+"   --yMIN   "+yMIN[i]+"   --yMAX   "+yMAX[i]+"   --LUMI   17.8   --dayMin   15-03-2016   --dayMax   30-12-2017   --noPU   --IetaMax   "+   str(ietamax*(1))   +   "   --IetaMin   "   +   str(ietamin*(1)) +    "      --IphiMin   "   +   str(iphimin)   +   "   --IphiMax   "   +   str(iphimax)  
       print   command;
...
#                                                                        outScript.write("\ncp   -v   /afs/cern.ch/user/l/lbrianza/work/public/ntupleEoP/*   .")
       ...
       #outScript.write("\ncp   -v   -r   "+categories[i]+"__/   /eos/user/v/vciriolo/EoP_monitoring/harness2017/Cal_Oct2017/SingleAndDouble/Cal_Oct2017_Ped_v2/"+categories[i]+"_"+ntupleName+"_ietamax_"+str(ietamin*(-1))+"_ietamin_"+str(ietamax*(-1))+"_iphimin_"+str(iphimin)+"_iphimax_"+str(iphimax)+"/")
       
       #outScript.write("\ncp   -v   -r   "+categories[i]+"__/   /eos/user/v/vciriolo/EoP_monitoring/harness2017/Cal_Oct2017/SingleAndDouble/Cal_Oct2017_PS_EoP_v1_k2/1nw/"+categories[i]+"_"+ntupleName+"_ietamax_"+str(ietamin*(-1))+"_ietamin_"+str(ietamax*(-1))+"_iphimin_"+str(iphimin)+"_iphimax_"+str(iphimax)+"/")
       outScript.write("\ncp   -v   -r   "+categories[i]+"__/   /eos/user/v/vciriolo/EoP_monitoring/harness2017/Cal_Oct2017/SingleAndDouble/Cal_Oct2017_PS_EoP_v1_k2/1nw/"+categories[i]+"_"+ntupleName+"_ietamax_"+str(ietamax*(1))+"_ietamin_"+str(ietamin*(1))+"_iphimin_"+str(iphimin)+"_iphimax_"+str(iphimax)+"/")
